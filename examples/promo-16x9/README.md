# Exemplo 16:9 — o vídeo de apresentação do próprio jsmotion

O GIF do topo do README ([`docs/demo.gif`](../../docs/demo.gif)) e o [`docs/demo.mp4`](../../docs/demo.mp4) (com trilha)
foram feitos **com a própria skill**: este `anim.js` usa o mesmo motor do `templates/example_anim.js`,
adaptado para **1280×720 · 12s**.
...
python3 scripts/build_html.py examples/promo-16x9/anim.js assets.js promo.html "jsmotion" jsmotion-promo
python3 scripts/render.py promo.html promo.mp4

# GIF leve para README (a granulação foi desligada nesta versão: ela muda a cada quadro e triplica o tamanho)
